...
/*
	The server.ClaimRouteHandler is the HTTP handler that processes
	incoming HTTP requests that contain the "/routes/claim" URL path.
	
	Notice that server.ClaimRouteHandler implements the HttpHandler interface,
	...
	server.ClaimRouteHandler.handle() which actually processes the request.
*/
