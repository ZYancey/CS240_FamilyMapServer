...
/*
	The server.ListGamesHandler is the HTTP handler that processes
	incoming HTTP requests that contain the "/games/list" URL path.
	
	Notice that server.ListGamesHandler implements the HttpHandler interface,
	...
	server.ListGamesHandler.handle() which actually processes the request.
*/
